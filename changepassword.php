	        ...
	        <table>
	            <tbody>
	                <tr>
	                     ...
	                     <td> <input style="border: 1px solid black;" size="25" type="password" name="oldpass" autocomplete="off" required></td>
	                </tr>
	                <tr>
	                     <td> <pre>New Password </pre> </td>
	                     <td> <input style="border: 1px solid black;" size="25" type="password" name="newpass" required></td>
	                </tr>
	                <tr>
