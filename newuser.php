            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td> <input style="border: 1px solid black;" type="text" name="username" autocomplete="off"> </td>
                    </tr>
                    <tr>
                        <td> <pre>Password </pre> </td>
                        <td> <input style="border: 1px solid black;" type="password" required name="password1"> </td>
                    </tr>
                    <tr>
                        <td> <pre>Confirm Password </pre></td>
                        <td> <input style="border: 1px solid black;" type="password" required name="password2"> </td>
                    </tr>
                    <tr>
                        <td>
                            <?php                            
                        ...
                        <td> <input style="border: 1px solid black;" type="text" name="captcha" autocomplete="off" required></td>
                    </tr>
                    <tr>
